<template>
    <div class="navbar navbar-fixed-bottom container-fluid">
        ...
        <p class="col-sm-6">{{tweet.full_text || tweet.text}}</p>
        <p class="col-sm-2"><a target="_blank" :href="[(tweet.url || 'https://twitter.com/' + (tweet.from_user_screenname || tweet.user_screen_name) + '/status/' + tweet.id)]">&#128279; link</a></p>
    </p>
    </div>
</template>
<script>
